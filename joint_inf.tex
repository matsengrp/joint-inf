...
\centering
% obtained by running
% python joint_inf_plot.py --topology --delta .001 --plot-name figures/topology-inconsistency.svg
...
\centering
% obtained by running
% python joint_inf_plot.py --restricted-branch-lengths --delta .001 --plot-name figures/branch-length-inconsistency.svg
...
\centering
% obtained by running
% python joint_inf_plot.py --general-branch-lengths --delta .001 --plot-name figures/w-hat-heatmap-joint-diff-evol.svg --n-jobs 10
\includegraphics[width=.9\textwidth]{w-hat-heatmap-joint-diff-evol}
\caption{
