...
%das: @EM do we need to point out that they limit themselves to BLs? this seems like text that was written before we showed the fixed-topology inconsistency
...
%das: I believe all of this terminology is fixed now
