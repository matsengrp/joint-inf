...
Initial results by of Dr\. Neher using the TreeTime \citep{Sagulenko2018-xl} package has shown that the region of parameter space on which joint inference infers a zero internal branch length for 4-state DNA models is smaller than that for 2-state binary models.
