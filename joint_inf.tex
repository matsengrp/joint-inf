...
Fidelities have useful algebraic properties, which mean that the generating probabilities using the Hadamard transform have an especially simple form (see either 8.6 of Semple and Steel \cite{Semple2003-em} or Appendix (TODO)).
...
$$
We give $\ell$ explicitly in the Appendix.
