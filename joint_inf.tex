...
%EM Dave, did you already address this comment? It doesn't seem to make sense anymore.
%Ah, yes, I believe it was commit 209f62b4ec37751a60c72edaa160b80d827bad04 (if that helps, for reference)
$$
...
The value of the likelihood for the site split $\{1,2\}$ is $(1+x')^2   (1-w')(1+y')^2$ since
$$
(1+x')^2   (1-w')(1+y')^2 > (1+x')(1-x')(1-w')(1+y')(1-y')
$$
always.
%EM Is this inequality flipped?
If $(1+x')(1-y') > (1-x')(1+y')$, then
$$
(1+x')^2(1-w')(1+y')(1-y') > (1+x')(1-x')(1-w')(1+y')^2
$$
meaning the cases $\{1\}, \{2\}, \{3\}$ and $\{1,2,3\}$ will have likelihoods equal to
$$
(1+x')^2(1-w')(1+y')(1-y').
$$
...
(1+x')^2(1-w')(1-y')^2
$$
as the likelihood in these cases.
The full likelihood in this case is then bounded below as
\begin{align*}
...
%EM it seems to me that the following line should be (1+x')(1-x')(1-w')(1+y')(1-y')
    %I've added some clarification to the text. Let me know if there is still an issue.
...
%EM it seems to me that the following line should be (1+x')(1-x')(1-w')(1+y')(1-y')
    ...
    &\qquad + p_{23}         \cdot\log((1-x')^2    (1-w')(1+y')^2).
\end{align*}
%EM check below after the above is adjusted.
Letting
$$
