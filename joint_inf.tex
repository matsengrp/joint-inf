...
\begin{theorem}
There exist $L_0$ and $L_1$ such that
$$
\max_{t} \ \ell_{\tau_1,t^*}(\tau_1, t; \fullAncestralSplitPartitions(\tau_1,t)) \le L_0,
$$
$$
\max_{t} \ \ell_{\tau_1,t^*}(\tau_2, t; \fullAncestralSplitPartitions(\tau_2,t)) \ge L_1
$$
and $L_1 > L_0$.
\end{theorem}
