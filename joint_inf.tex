...
A maximization procedure will more likely introduce a $(1+w)$ term than a $(1-w)$ term, though this will not be guaranteed as the maximum depends on the values of the unknown branch parameters $t$.
...
%TODO: does this bias make sense? should it be log-diff?
...
%TODO: double check the below sentence
