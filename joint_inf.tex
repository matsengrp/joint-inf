...
%EM I think that this is enough. In the lcfit paper we referenced the Semple and Stell phylogenetics book.
...
\centering
% obtained by running
% python joint_inf_plot.py --empirical --general-branch-lengths --delta .001 --plot-name figures/w-hat-empirical-001-marginal.svg --out-pkl-name figures/w-hat-empirical-001-marginal.pkl --n-jobs 16 --marginal
% or
% python joint_inf_plot.py --empirical --general-branch-lengths --plot-name figures/w-hat-empirical-001-marginal.svg --in-pkl-name figures/w-hat-empirical-001-marginal.pkl
% if fit already
% !! TODO: update with finer-grained plot; this is a placeholder as the global optimization runs...
...
\centering
% obtained by running
% python joint_inf_plot.py --empirical --general-branch-lengths --delta .001 --plot-name figures/w-hat-empirical-001.svg --out-pkl-name figures/w-hat-empirical-001.pkl --n-jobs 16
% or
...
%EM Re LBA I was only thinking of putting a little sentence here that says that thus this is _not_ long branch attraction.
%EM I don't know what "similar character" means here. I guess you are talking about his Figure 2?
