...
The alternative approach \cite{Sagulenko2017-jo} does away with the marginalization and directly estimates the maximum likelihood parameters of the fully-observed likelihood in \eqref{eq:full_likelihood}, though only branch lengths are estimated as the topology is fixed in advance.
...
This inconsistency in the case of long branches concurs with some empirical findings in \cite{Sagulenko2017-jo}, namely their Figures 2 and 3.
