...
Following Section 8.6 of \cite{Semple2003-em}, we define an ordered set of tip labels $\{1,\ldots,\nSiteRows\}$ on $\tau$ across sites.
...
%EM inducing again.
For topology $\tau$, we also define an ordered set of internal nodes $\{1,\ldots,\nAncestralStateRows\}$ for $\ancestralStateColumn_i$ with a similar subset of characters $\ancestralSplit\subseteq\ancestralSplitSet:=\{1,\ldots,\nAncestralStateRows\}$ describing a realization of $\ancestralStateColumn_i$.
...
%EM I guess the ith component of H is h_i?
    %das: Not sure what the question/comment is here.
