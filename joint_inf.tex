...
%EM Is it indicated anywhere how the internal nodes are numbered? I would assume that 1 would be connected to leaf 1. If that's true please indicate here.
...
%EM Yeah, this next statement feels like it could use some justification, and or maybe you could skip to the following statement.
Using the Hadamard transform approach outlined in 8.6 of Semple and Steel \cite{Semple2003-em}, we calculate the generating probabilities the Farris tree topology.
For site split $\emptyset$,
\begin{align*}
    P(\siteSplit=\emptyset|\tau_1, \tilde{t}) & = \frac{1}{8} \cdot (1 + x_1x_2 +  y_1y_2 +  x_1y_1w + x_1y_2w + y_1x_2w + x_2y_2w + x_1y_1x_2y_2) \\
                                              & = \frac{1}{8} \cdot (1 + x_1x_2 +  y_1y_2 +  w[x_1y_1 + x_1y_2 + y_1x_2 + x_2y_2] + x_1y_1x_2y_2) \\
                                              & = \frac{1}{8} \cdot (1 + x_1x_2 +  y_1y_2 +  w[x_1 + x_2][y_1 + y_2] + x_1y_1x_2y_2).
\end{align*}
...
\begin{align*}
    P(\siteSplit=\{1\}|\tau_1, \tilde{t}) & = \frac{1}{8} \cdot (1 - x_1x_2 +  y_1y_2 +  w[-x_1 + x_2][y_1 + y_2] - x_1y_1x_2y_2)
\end{align*}
and for site split $\{3\}$ we have
\begin{align*}
    P(\siteSplit=\{3\}|\tau_1, \tilde{t}) & = \frac{1}{8} \cdot (1 - x_1x_2 +  y_1y_2 +  w[x_1 - x_2][y_1 + y_2] - x_1y_1x_2y_2)
\end{align*}
...
\begin{table}
%EM I wonder why you use primes on all variables here but not in tab:likelihoods.
\centering
\begin{tabular}{|l|l|l|}
    \hline
...
$$
%EM I'd suggest p_\emptyset for this particular one, but perhaps that will throw off your spacing below.
