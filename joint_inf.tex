...
%EM This doesn't look like the same inequality to me.
%das: updated
...
We do not include zero or one in our lattice to further stabilize the fits, as these cases can result in pathologies\footnote{\url{https://github.com/matsengrp/joint-inf/blob/master/joint_inf_plot.py}}.
%EM Need GH link here.
...
%EM Also, is there any hope that an alternate profile likelihood formulation could lead to more consistent estimation? It'd be nice to end with something like that.
%das: wow, that would be an undertaking. The only thing I know off the top of my head are things like sieves, which I recall Paul Edlefsen being jazzed about but don't know if he uses them in this way. I can think more but it might just be a vague throwaway line.
%das: Was just reading more on this and it's not obvious to me if sieves would even apply here. I'll think about it more but pass everything else off to you for now.
