...
In general, the functional form of \eqref{eq:profile_likelihood} is determined by inequalities arising from taking maxima over ancestral state splits in Table~\ref{tab:farris_likelihoods} to obtain the conditional likelihood term for each most likely ancestral state split, these terms depending on the unknown $(\tau, t)$.
