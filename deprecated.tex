...
\begin{align*}
    ...
    &\qquad + \log(1+w').
\end{align*}
% das: there might be something with 1+y^2 < 1+y here? I'm not sure how specifically it would affect the maximization, and it might be too loose of a bound, but could work to try
