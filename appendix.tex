...
%das: added it to the table headings, too
...
%das: got rid of all the proportional talk and just explicitly wrote out the likelihood
...
%das: the negative sign comes from b13 -> b0. I have written all the steps out explicitly so it's more clear.
