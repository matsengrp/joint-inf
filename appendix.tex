...
Thus, the Hessian of the sum of the divergence and the partial log-likelihood will be negative definite, as the Hessian for the divergence is negative definite, and there exists a unique maximum to the likelihood over $x_1,x_2,y_1,y_2\in(0,1)$.
