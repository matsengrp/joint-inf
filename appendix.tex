...
Assuming $x_1,y_1,x_2 < 1$ precludes all cases where $c_{x_1,\siteSplit_j} + a_{x_1,\siteSplit_j}x_1 = 0$ for some $j$.
Moreover, we have
\[
...
Since $x^*, y^* < 1$, the assumption that $x_1,y_1,x_2 < 1$ is reasonable.
