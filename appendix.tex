...
\begin{align*}
    p_{13} & = \log(1+x^2+y^2-4xyw+x^2y^2) \\
                  ...
                  & \le \log((1+x)(1+y)).
\end{align*}
%EM You dropped the below parenthetical reminder. Did you think that it was clear?
%das: I guess when reading it I thought it disrupted the flow, but I think you're right that clarity is probably better in this instance.
