...
\begin{tabular}{|l|ll|}
    ...
    $\begin{array}{l}
                ...
                \end{array}$&
    $\begin{array}{l}
    %EM This doesn't seem right to me-- for all of these, shouldn't x_1 and x_2 have the same coefficient?
                    (1-x_1)(1+x_2)(1+w)(1-y_1)(1+y_2)\\
                    (1+x_1)(1-x_2)(1-w)(1-y_1)(1+y_2)\\
                    (1-x_1)(1+x_2)(1-w)(1+y_1)(1-y_2)\\
                    (1+x_1)(1-x_2)(1+w)(1+y_1)(1-y_2)
...
\]
%EM It sounds like you are saying that this is the only case in which the above equality can happen, which is not the case, right? Isn't there a whole 2-dimensional set that has this equality?
...
To resolve this ambiguity, we look to the divergence quantity that is maximized when $x_1=x_2$ and $y_1=y_2$, and, thus, the full joint likelihood obtains a unique maximum when $x_1=x_2$ and $y_1=y_2$.
