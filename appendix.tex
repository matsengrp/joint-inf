...
Consider the general case of $\tilde{t}=\{x_1, y_2, x_1, y_2, w\}$; we restrict our attention to $x_1,y_1,x_2,y_2,w\in(0,1)$, i.e., cases where $0<p_{\siteSplit_j}<1$ for all $\siteSplit_j$.
...
The second derivative of the divergence term $\shannonDivergence_{\tau^*,t^*}(\tau^*,\tilde{t}) = -g(x_1)\log g(x_1)$ is
\[
