...
Note the following:
\begin{itemize}
\item $a_{\emptyset} = -a_{13}$, $p_{\emptyset} \ge p_{13}$;
\item $a_{1} = -a_{3}$, $p_{1} = p_{3}$;
\item $a_{2} = -a_{123}$, $p_{2} = p_{123}$;
\item $a_{12} = -a_{23}$, $p_{12} = p_{23}$;
\end{itemize}
so
\begin{align*}
\ell'(w) &= \frac{1}{1+w} + \frac{p_{\emptyset}a_{\emptyset}}{1 + a_{\emptyset}w} - \frac{p_{13}a_{\emptyset}}{1 - a_{\emptyset}w} + \frac{p_{2}a_{2}}{1 + a_{2}w} - \frac{p_{2}a_{2}}{1 - a_{2}w} \\
         &\qquad \frac{p_{1}a_{1}}{1 + a_{1}w} - \frac{p_{1}a_{1}}{1 - a_{1}w} + \frac{p_{12}a_{12}}{1 + a_{12}w} - \frac{p_{12}a_{12}}{1 - a_{12}w} \\
\end{align*}
...
\]
\[
0 \le a_{1} \le \frac{x^*}{1-(x^*)^2}
\]
\[
0 \le a_{12} \le \frac{x^*}{1-(x^*)^2}\cdot\frac{1}{1-y^*},
\]
so that $\ell'(w)$ has lower bound
\[
\ell'_{L}(w) = \frac{1}{1+w} - \frac{p_{13}}{c_1 - w} - \frac{p_{2}}{c_1c_2 - w} - \frac{p_{1}}{c_3 - w} - \frac{p_{12}}{c_2c_3 - w}
\]
with
\[
c_1 = \frac{1+(x^*)^2}{2x^*},
...
We see
\[
\ell'_{L}(0) = 1 - \frac{p_{13}}{c_1} - \frac{p_{2}}{c_1c_2} - \frac{p_{1}}{c_3} - \frac{p_{12}}{c_2c_3} > 0
\]
provided $c_1c_2, c_3, c_2c_3 > 1$
...
So we want $x^*$ and $y^*$ where $c_1c_2, c_3, c_2c_3 > 1$ and $\ell_L'(1) > 0$.
These conditions are straightforward, the one on the derivative being
\[
\ell'_{L}(1) = \frac{1}{2} - \frac{p_{13}}{c_1-1} - \frac{p_{2}}{c_1c_2-1} - \frac{p_{1}}{c_3-1} - \frac{p_{12}}{c_2c_3-1} > 0.
\]
