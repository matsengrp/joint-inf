...
& \multicolumn{2}{|c|}{$\ancestralSplit_k$}\\
    ...
    \hline
\end{tabular}
\caption{Likelihood calculations for all site patterns and internal states of Farris tree.
...
$$
C_0(x^*, y^*) := \max\left(L^{1}_{\tau_1,\tau_1}(x^*, y^*), L^{2}_{\tau_1,\tau_1}(x^*, y^*), L^{3}_{\tau_1,\tau_1}(x^*, y^*)\right).
$$
...
$$
See Fig.~\ref{fig:inconsistency-farris} for the values of $0 < x^*, y^* < 1$ where $C_1(x^*, y^*) > C_0(x^*, y^*)$ and joint inference in inconsistent.
\end{proof}
