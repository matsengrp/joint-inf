...
Likelihood computations for all site patterns and ancestral states are in Tables~\ref{tab:farris_likelihoods} (for the Farris tree) and~\ref{tab:fels_likelihoods} (for the Felsenstein tree).
