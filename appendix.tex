...
We can compute the partial log-likelihood $\tilde{\ell}_{\tau^*,t^*}(\tau^*, t)$ using Table~\ref{tab:farris_likelihoods}.
...
\]
%das: TODO double check restrictions on \hat{x} and \hat{y} are reasonable
...
%das: @EM I made this not a theorem since it's now a special case. Should it stay a theorem?
Let
\[
