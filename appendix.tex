...
We use the fact that $x_1=x_2$ as there exists a unique solution and the likelihood is invariant to swapping these two variables.
Let
\[
...
Moreover, as shown previously, each of these objective functions has a unique maximum on $[0,1]^5$.
